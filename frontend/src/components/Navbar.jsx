    ...
    <div className="navbar flex items-center justify-between py-5 font-medium">
      ...
      <ul className="hidden sm:flex gap-5 text-sm text-gray-700">
        ...
        <NavLink to="/collection" className="flex flex-col items-center gap-1 ">
          <p>COLLECTION</p>
          <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden active:d" />
        </NavLink>
      ...
      <div className="flex items-center gap-6">
        <img onClick={(e) => setShowSearch(true)} src={assets.search_icon} className="w-5 cursor-pointer" alt="" />
